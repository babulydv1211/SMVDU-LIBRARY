...
const [authUser,setAuthUser]=useAuth()
  ...
  const handleScroll=()=>{
    ...
    const navItems=(<>
<li className="font-black font-medium text-lg">
        <a href="/">Home</a>
     </li >
     <li  className="font-black font-medium text-lg">
  ...
  return (
    ...
    <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
      sticky? "sticky-navbar shadow-md bg-base-300 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out": ""
    }`}>
  ...
  <div className="navbar-start">
    ...
    <a className="text-3xl font-bold cursor-pointer">SMVDU-LIBRARY</a>
  </div>
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1">
      {/* yaha add kiya gya h navbar ka item jo uper min bana h */}
      {navItems}
    </ul>
  </div>
